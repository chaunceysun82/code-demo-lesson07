...
def test_hr():
    ...
    print(file_contents)
    assert file_contents == Element.indent + '<hr />\n'
...
def test_hr_attr():
    ...
    file_contents = render_result(hr)
    print(file_contents)
    assert file_contents == Element.indent + '<hr width="400" />\n'
...
def test_br():
    ...
    print(file_contents)
    assert file_contents == Element.indent + "<br />\n"
...
def test_anchor():
    ...
    print(file_contents)
    assert file_contents.startswith(Element.indent + '<a ')
...
def test_indent():
    ...
    """
    html = Html("some content", ind="   ")
    file_contents = render_result(html).rstrip()  #remove the end newline
